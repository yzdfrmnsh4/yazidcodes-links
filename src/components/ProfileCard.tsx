...
avatarUrl = '/yazid.png', // Set to empty string for customizable default
  iconUrl = '',
  grainUrl = '/grain.j',
  innerGradient,
  behindGlowEnabled = false, // disabled by default per user request
  behindGlowColor,
  behindGlowSize,
  className = '',
  enableTilt = true,
          ...
          >
              ...
              {showUserInfo && (
                ...
                >
                  <div className="flex items-center gap-3">
                    <div
                      className="rounded-full overflow-hidden border border-white/10 flex-shrink-0 bg-slate-800 flex items-center justify-center font-bold text-xs text-white"
                    ...
                    <div className="flex flex-col items-start gap-1">
                      ...
                      <div className="text-[11px] text-white/75 leading-none mt-0.5">{status}</div>
                    </div>
                  </div>
                  <button
                    className="border border-white/20 hover:border-white/50 rounded-lg px-2.5 py-1.5 text-[10px] font-bold text-white/95 cursor-pointer backdrop-blur-[10px] transition-all duration-200 ease-out hover:-translate-y-px"
            ...
            >
              <div className="w-full absolute flex flex-col" style={{ top: '2.5em', display: 'flex', gridArea: 'auto' }}>
                <h3
                  className="font-extrabold m-0 leading-tight"
                  style={{
                    fontSize: '1.55rem',
                    backgroundImage: 'linear-gradient(to bottom, #ffffff, #a5b4fc)',
                ...
                <p
                  className="font-medium whitespace-nowrap mx-auto w-min text-xs mt-1 px-2.5 py-0.5 rounded-full bg-slate-900/60 border border-white/5 text-slate-300"
                  style={{
                    display: 'block',
                    gridArea: 'auto',
                    pointerEvents: 'auto'
