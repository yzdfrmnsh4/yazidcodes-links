...
export const DynamicIcon: React.FC<DynamicIconProps> = ({ name, className = '', size = 24 }) => {
  ...
  if (normName === 'tiktok') {
    return (
      ...
      >
        ...
        <ImageWithSkeleton src="/iconn/tiktok.png" alt="tiktok-icon" className="w-full h-full" />
  ...
  if (normName === 'instagram') {
    return (
      ...
      >
        ...
        {/* <Insta /> */}
        <ImageWithSkeleton src="/iconn/instagram.png" alt="instagram-icon" className="w-full h-full" />
  ...
  if (normName === 'linkedin') {
    return (
      ...
      >
        ...
        {/* <LinkedIn  /> */}
        <ImageWithSkeleton src="/iconn/linkedin.png" alt="linkedin-icon" className="w-full h-full" />
  ...
  if (normName === 'github') {
    return (
      ...
      >
        ...
        {/* <GitHub  /> */}
        <ImageWithSkeleton src="/iconn/github.png" alt="github-icon" className="w-full h-full" />
  ...
  if (normName === 'whatsapp') {
    return (
      ...
      >
        {/* <div className="absolute top-0 left-0 w-full h-1/2 bg-gradient-to-b from-white/25 to-transparent pointer-events-none" /> */}
        {/* <WhatsApp /> */}
        <ImageWithSkeleton src="/iconn/whatsApp.png" alt="whatsapp-icon" className="w-full h-full" />
  ...
  if (normName === 'finder') {
    ...
    return (
      ...
      >
      <ImageWithSkeleton src="/iconn/finder.png" alt="finder-icon" className="w-full h-full" />
  ...
  if (normName === 'spotify') {
    return (
      ...
      >
        ...
        <ImageWithSkeleton src="/iconn/spotify.png" alt="spotify-icon" className="w-full h-full" />
  ...
  if (normName === 'photos' || normName === 'gallery') {
    ...
    return (
      ...
      >
        <ImageWithSkeleton src="/iconn/photos.png" alt="gallery-icon" className="w-full h-full" />
      </div>
    );
  }
  ...
  if (normName === 'notes') {
    ...
    return (
      ...
      >
        {/* Header grid texture */}
        <ImageWithSkeleton src="/iconn/stickynotes.png" alt="stickynotes-icon" className="w-full h-full" />
