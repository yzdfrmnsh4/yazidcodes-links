...
export const AudioProvider: React.FC<{ children: React.ReactNode }> = ({ children }) => {
  ...
  const [tracks, setTracks] = useState<Track[]>([
    ...
    },
    {
      ...
      src: "/music/That's Why (You Go Away) (2014 Remaster).mp3",
      coverGradient: "from-pink-500 via-purple-600 to-indigo-700",
      coverUrl: "/album/thatsWhy.jpg",
    ...
    },
    {
      ...
      src: "/music/Ada titik-titik di ujung doa.mp3",
      coverGradient: "from-emerald-400 via-teal-500 to-cyan-600",
      coverUrl: "/album/titikdiujungdoa.jpg",
